...
public class RestSourceConnectorConfigTest {
  ...
  public void testConfig() {
    ...
    props.put("rest.source.properties", "Content-Type:application/json");
    props.put("rest.source.headers", "Accept:application/json");
    ...
    assertEquals("a:b,c:d", config.getPayloadReplacements());
    assertEquals("z", config.getPayloadRemovals());
    assertEquals("key:val", config.getPayloadAdditions());
    ...
    assertNotNull(config.getPayloadToSourceRecordConverter());
