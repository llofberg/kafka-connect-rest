...
public class RestSinkConnectorConfigTest {
  ...
  public void testInit() {
    ...
    props.put("rest.sink.properties", "Content-Type:application/json");
    props.put("rest.sink.headers", "Accept:application/json");
    ...
    assertNotNull(config.getSinkRecordToPayloadConverter());
